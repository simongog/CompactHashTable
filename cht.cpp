...
cht::cht(unsigned long long universe, unsigned long long n, unsigned int sat, double epsilon, unsigned int difference):
	dif(difference),
	M( (1+epsilon)*n+1),
	nodeNumberCount(0),
	cmax(universe-1),
 ...
 */
bool cht::isPrime(unsigned long long input){
 ...
 */
unsigned long long cht::nextPrimeNumber(unsigned long long inputNumber){
...
*/
unsigned long long cht::find(unsigned long long key)
{
...
*/
unsigned long long cht::getSatelite(unsigned long long vVal,unsigned long long cVal, unsigned long long quotient)
{
 ...
 * as satelite data
*/
void cht::insert (unsigned long long key, unsigned int value)
{
	unsigned long long cRand= ((key %prime)*a)%prime;
	unsigned long long initAd= cRand % M;
	unsigned long long quotient= cRand/M;
...
*/
void cht::findSpace(unsigned long long cVal, unsigned long long quotient)
{
	unsigned long long curC;
	//check if the value is already inserted
	unsigned long long tmpSlot;
...
*/
void cht::startNewBlock(unsigned long long vVal,unsigned long long cVal){
...
*/
unsigned long long cht::getChangeBitLoc(unsigned long long curAddress)
{
...
bool cht::itemExists(unsigned long long cVal, unsigned long long quotient)
{
